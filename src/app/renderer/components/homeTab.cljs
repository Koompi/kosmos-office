...
(defn homeTab
  ...
  [:div {:className "ribbonMainGroup"}
      [:ul
          ...
          [:li {:data "Redo" :className "ribbonIcon" :style {:backgroundImage "url('img/redo.png')"}}]
          [:li {:data "Cut" :className "ribbonIcon" :style {:backgroundImage "url('img/cut.png')"}}]
          [:li {:data "Copy" :className "ribbonIcon" :style {:backgroundImage "url('img/copy.png')"}}]
          [:li {:data "Paste" :className "ribbonIcon" :style {:backgroundImage "url('img/paste.png')"}}]
          ...
          [:li {:data "Format Printer" :className "ribbonList"}
            [:form
              ...
              [:select {:type "select" :name "fontSize"}
                ...
                [:option {:value "4"} "10"]
                [:option {:value "5"} "11"]]]]
          [:li {:data "Increase Font Size" :className "ribbonIcon" :style {:backgroundImage "url('img/increaseFont.png')"}}]
          [:li {:data "Decrease Font Size" :className "ribbonIcon" :style {:backgroundImage "url('img/decreaseFont.png')"}}]
